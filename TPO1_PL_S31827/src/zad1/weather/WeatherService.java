...
public class WeatherService{
    ...
    private static final String API_WEATHER_GET_WEATHER_OLD="https://api.openweathermap.org/data/2.5/weather?q=%s,%s&units=metric&appid=%s";

    static public Weather getWeatherOld(String country,String city ) throws NullPointerException{
        return Utils.requestUrl(URI
                        .create(String.format(API_WEATHER_GET_WEATHER_OLD,
                                city,
